  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      axios
        ...
        .then((response) => setResults(response.data.filter((result) => result.id !== auth.user.id)))
    }, 500)
