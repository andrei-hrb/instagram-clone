    ...
    <div className="min-h-screen bg-gray-100">
                ...
                <Dropdown>
                  <Dropdown.Trigger>
                    <span className="inline-flex rounded-md">
                      ...
                      >
                        <img
                          src={auth.user.image?.url ?? '/default.png'}
                          alt={`${auth.user.name}'s avatar`}
                          className="w-10 h-10 object-cover rounded-full border mr-2"
                        />
                        {auth.user.name}
                  ...
                  <Dropdown.Content>
                    <Dropdown.Link href={route('profile.show', auth.user.id)}>See your Profile</Dropdown.Link>
                    <Dropdown.Link href={route('profile.edit')}>Edit your Profile</Dropdown.Link>
        ...
        <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
          ...
          <div className="pt-4 pb-1 border-t border-gray-200">
            ...
            <div className="mt-3 space-y-1">
              <ResponsiveNavLink href={route('profile.show', auth.user.id)}>See your Profile</ResponsiveNavLink>
              <ResponsiveNavLink href={route('profile.edit')}>Edit your Profile</ResponsiveNavLink>
      ...
      {header && (
        <header className="bg-white shadow">
          <div className="max-w-4xl mx-auto py-6 px-4 sm:px-6 lg:px-8">{header}</div>
        </header>
      )}
